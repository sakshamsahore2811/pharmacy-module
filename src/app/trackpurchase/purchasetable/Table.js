            ...
            <table className="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>19-08-2019</td>
                        <td><Link href="#">ORD#1562792774779 - 31</Link></td>
                        <td>19-08-2019</td>
                    ...
                    <tr>
                        <td>Wade Warren</td>
                        <td>19-08-2019</td>
                        <td><Link href="#">ORD#1562792776427 - 28</Link></td>
                        <td>19-08-2019</td>
                    ...
                    <tr>
                        ...
                        <td>19-08-2019</td>
                        <td><Link href="#">ORD#1562792771583 - 13</Link></td>
                        <td>19-08-2019</td>
                        <td style={{ color: "#176AB6", background: "#FAFFEE", padding: "4px 8px 4px 8px", borderRadius: "32px", margin: "1rem", fontSize: "12px", fontWeight: "600" }}>Delivery awaiting</td>
                    </tr>
                    <tr>
                        <td>Annette Black</td>
                        <td>19-08-2019</td>
                        <td><Link href="#">ORD#1562792777582 - 01 </Link></td>
                        <td>19-08-2019</td>
                    ...
                    <tr>
                        <td>Ralph Edwards</td>
                        <td>19-08-2019</td>
                        <td><Link href="#">ORD#1562792778679 - 07</Link></td>
                        <td>19-08-2019</td>
                        <td style={{ color: "#D55F5A", background: "#FEF7F7", padding: "4px 4px 4px 8px", borderRadius: "32px", margin: "1rem", fontSize: "12px", fontWeight: "600" }}>Returned</td>
                    ...
                    <tr>
                        ...
                        <td>19-08-2019</td>
                        <td><Link href="#">ORD#1562792773536 - 10</Link></td>
                        <td>19-08-2019</td>
                    ...
                    <tr>
                        ...
                        <td>19-08-2019</td>
                        <td><Link href="#">ORD#1562792771583 - 09</Link></td>
                        <td>19-08-2019</td>
                        <td style={{ color: "#166534", background: "#F0FDF4", padding: "4px 4px 4px 8px", borderRadius: "32px", margin: "1rem", fontSize: "12px", fontWeight: "600" }}>Delivered</td>
